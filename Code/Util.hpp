...
#	define CONSTEXPR_JOAAT_IMPL(x) (::Chimera::ConstexprJooat<sizeof(x) - 1>((x), std::make_index_sequence<sizeof(x) - 1>()).GetHash())
#	define CONSTEXPR_JOAAT(x) (std::integral_constant<rage::joaat_t, CONSTEXPR_JOAAT_IMPL(x)>::value)
}
